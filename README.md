...
CLI for this tool is fantastic, mainly because it fits naturally into how Git and developers already work in, while staying fast, simple, and secure. Also it uses Standard Library Modules which are built into Python and available without extra installation. 
